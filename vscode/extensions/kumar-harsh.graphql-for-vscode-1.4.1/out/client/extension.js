...
function activate(context) {
    ...
    let client = new vscode_languageclient_1.LanguageClient('Graphql For VSCode', serverOptions, clientOptions);
    // Push the disposable to the context's subscriptions so that the
    // client can be deactivated on extension deactivation
    context.subscriptions.push(client.start(), vscode_1.commands.registerCommand('graphqlForVSCode.showOutputChannel', () => { client.outputChannel.show(); }), statusBarItem);
