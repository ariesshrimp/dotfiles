...
class CommandHandler {
    ...
    begin() {
        this.disposables.push(vscode.commands.registerTextEditorCommand('better-merge.accept.current', this.acceptCurrent, this), vscode.commands.registerTextEditorCommand('better-merge.accept.incoming', this.acceptIncoming, this), vscode.commands.registerTextEditorCommand('better-merge.accept.selection', this.acceptSelection, this), vscode.commands.registerTextEditorCommand('better-merge.accept.both', this.acceptBoth, this), vscode.commands.registerTextEditorCommand('better-merge.accept.all-current', this.acceptAllCurrent, this), vscode.commands.registerTextEditorCommand('better-merge.accept.all-incoming', this.acceptAllIncoming, this), vscode.commands.registerTextEditorCommand('better-merge.accept.all-both', this.acceptAllBoth, this), vscode.commands.registerTextEditorCommand('better-merge.next', this.navigateNext, this), vscode.commands.registerTextEditorCommand('better-merge.previous', this.navigatePrevious, this));
    }
