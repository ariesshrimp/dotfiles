...
class MergeDectoratorService {
    ...
    applyDecorations(editor) {
        ...
        if (!merge_conflict_parser_1.default.containsConflict(editor.document)) {
        ...
        merge_conflict_parser_1.default.scanDocument(editor.document).forEach(conflict => {
...
exports.default = MergeDectoratorService;
//# sourceMappingURL=merge-decorator-service.js.map